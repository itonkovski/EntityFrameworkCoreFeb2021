...
namespace _04.AddMinion
{
    public class Program
    {
        static void Main()
        {
            ...
            var connection = new SqlConnection("Server=localhost;User Id = SA;Password = Qawsed12;Database=MinionsDB");
            connection.Open();
            ...
            else
            {
                ...
                commandAddMinionToVillain.Parameters.AddWithValue("@villainId", minionId);
                commandAddMinionToVillain.Parameters.AddWithValue("@minionId", villainId);
